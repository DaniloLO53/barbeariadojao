...
export default function Home() {
  const { registerScreen, registerScreenOpened, setRegisterScreenOpened } = useAuthContext();

  const loginHandler = () => {
    setRegisterScreenOpened(!registerScreenOpened);
  };

  return (
    <main>
      {registerScreenOpened && (
        <RegisterScreen setRegisterScreenOpened={setRegisterScreenOpened} >
          { registerScreen }
        </RegisterScreen>
      )}
